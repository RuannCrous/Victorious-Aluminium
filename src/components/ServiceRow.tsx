  ...
  return (
    <Link href={`/services#${slug}`} className="group block rule-t">
      <div className="grid grid-cols-12 items-baseline gap-4 py-8 md:py-10">
        ...
        <h3 className="col-span-10 font-display text-3xl font-medium leading-tight tracking-normal transition-colors duration-300 group-hover:text-brand md:col-span-6 md:text-5xl">
          {service.title}
        </h3>
