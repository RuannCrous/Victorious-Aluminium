...
import { serviceMeta, site } from "@/lib/site";
    ...
    <>
      ...
      <section className="shell py-24 md:py-32">
        <div className="grid gap-10 md:grid-cols-12">
          ...
          <Reveal className="md:col-span-9" delay={0.05}>
            <p className="max-w-4xl font-sans text-2xl font-normal leading-[1.45] tracking-normal text-ink sm:text-3xl sm:leading-[1.4] md:text-4xl md:leading-[1.34]">
              {t.home.introMain}
      ...
      <section className="bg-bone">
        <div className="shell py-24 md:py-32">
          ...
          <Reveal delay={0.05} className="mt-8 flex flex-col items-start gap-8 md:flex-row md:items-end md:justify-between">
            <div>
